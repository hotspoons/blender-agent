...
# The extension's rigging dir: parent of blrig/, corpus/ and tests/.
# Inserted on sys.path so `import blrig` / `import corpus` / `import tests.*`
# resolve inside Blender, where the wheel isn't installed.
